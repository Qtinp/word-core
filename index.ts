 ...
 * @returns 结果
 */
export const initiative = (q: string, playData: { [key: string]: string }) => {
  return driver.initiativeStart(q, playData);
};

// 加载额外主动库
fs.readdirSync(path.join(__dirname, './Function/initiative/')).forEach(
  (value) => {
